...
from vdsl.dsl_parse import MONSTER_LIST, ITEMS_IN_INTEREST, \
...
class Vizdoom_env(object):
    def __init__(self, config='vizdoom_env/asset/default.cfg', verbose=False,
                 perception_type='more_simple', env_task='preloaded'):
    ...
    def take_action(self, action):
        ...
        r = self.game.make_action(action_vector, frame_skip)
        return r
    ...
    def get_state_reward(self, r=None):
        if self.env_task == 'survive':
            ...
            raise NotImplementedError('{} not yet implemented'.format(self.env_task))
