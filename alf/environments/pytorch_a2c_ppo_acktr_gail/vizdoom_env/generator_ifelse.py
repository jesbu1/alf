...
from vdsl.dsl_parse import parse as vizdoom_parse
from vdsl.random_code_generator_ifelse import DoomProgramGenerator
...
def main():
    ...
    parser.add_argument('--dir_name', type=str, default='vizdoom_dataset_ifelse')
    parser.add_argument('--num_train', type=int, default=10000)
    parser.add_argument('--num_test', type=int, default=1000)
    parser.add_argument('--num_val', type=int, default=100)
    parser.add_argument('--seed', type=int, default=123)
    parser.add_argument('--max_program_length', type=int, default=19)
    parser.add_argument('--min_demo_length', type=int, default=2)
    parser.add_argument('--max_demo_length', type=int, default=2)
    parser.add_argument('--num_demo_per_program', type=int, default=40)
    parser.add_argument('--num_test_demo_per_program', type=int, default=10)
